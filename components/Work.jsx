...
const Work = () => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      <h4 className="text-center mb-2 text-lg font-Ovo">What Portfolio</h4>
      ...
      <div className="grid grid-cols-auto my-10 gap-5">
        {workData.map(({ title, description, bgImage }, i) => (
          <div
            key={i}
          ...
          >
            <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              ...
              <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shrink-[2px_2px_0_#000] group-hover:bg-lime-300 transition">
